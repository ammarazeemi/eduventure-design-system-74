...
const GamePlay = () => {
  ...
  // Find the correct game from the allGames data
  const currentGame = allGames.find(game => 
    game.subject === subject && game.name === decodedGameName
  );

  // Default fallback questions if game not found
  ...
  // Use game-specific questions or fallback
  const questions = currentGame?.questions || defaultQuestions;
